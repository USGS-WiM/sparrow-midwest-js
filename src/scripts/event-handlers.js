function loadEventHandlers() {
    ...
    selectPolygons.click(function() {
        if (app.clickSelectionActive) {
            ...
            if (app.userSelectedShapes.length == 0 && app.polygonResponseCount > chartFeatureMax) {
                $("#chartButton")
                    .prop("disabled", true)
        ...
        switch ($("#groupResultsSelect")[0].selectedIndex) {
            ...
            case 2: //Tributary
                ...
                if (app.getLayerDefObj().AOI3) {
                    clearAOIandAppendWarning("grp3-warning", "HUC8", "HUC8", "#grp3-select", "AOI3");
                }
            ...
            case 3: //River Basin
                ...
                //huc8
                if (app.getLayerDefObj().AOI3) {
                    clearAOIandAppendWarning("grp3-warning", "HUC8", "River Basin", "#grp3-select", "AOI3");
                }
                $("#grp3-select").attr("disabled", "disabled"); //huc8
                $("#grp3-select").addClass("disabled");
                $("#grp3-select").selectpicker("refresh");
    ...
    $("#chartButton").on("click", function() {
        ...
        if (app.userSelectedDispFieldName != "") {
            app.formattedHighlightString =
                app.userSelectedDispFieldName + " IN (" + app.userSelectedShapes.join(",") + ")";
